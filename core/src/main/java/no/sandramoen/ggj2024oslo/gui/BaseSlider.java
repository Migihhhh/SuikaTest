...
public class BaseSlider extends Table {
    ...
    private Label labelInit(String labelText) {
        Label label = new Label(labelText, AssetLoader.getLabelStyle("Play-Bold20white"));
        GameUtils.addWidgetEnterExitEffect(label, Color.LIGHT_GRAY, Color.WHITE);
        return label;
    }

    private void setContainerHoverColor(Container<Slider> container, Label label) {
